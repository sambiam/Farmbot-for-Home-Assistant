...
SOIL_CAPTURE_MAX_PHOTO_ATTEMPTS = 5
SOIL_CAPTURE_IMAGE_TIMEOUT_SECONDS = 60
SOIL_CAPTURE_COORDINATE_TOLERANCE_MM = 5.0
SOIL_CAPTURE_POSITION_TOLERANCE_MM = 5.0
SOIL_CAPTURE_POSITION_TIMEOUT_SECONDS = 60
SOIL_CAPTURE_LIGHTING_PIN = 7
